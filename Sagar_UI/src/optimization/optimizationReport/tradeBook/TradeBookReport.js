import {
  formatDataForExcel,
  exportToExcel,
} from "../../../backtest/ExportToExcel";
import { FullReport } from "../../../backtest/fullReport/FullReport";
import { OverallPerformance } from "../../../backtest/overallPerformance/OverallPerformance";

const TradeBookReport = (props) => {
  const { data } = props;
  ...
  const download = () => {
    ...
    exportToExcel({ data: dataToExport, fileName: "optimization_report" });
  };
    ...
    <>
      <div className="box">
        <div className="cell backtest-report-header">
          <h6 className="box-title">Trade Book</h6>
