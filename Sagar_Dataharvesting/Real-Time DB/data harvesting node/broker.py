...
class XTSlogin:
    def __init__(self, root_url):
        ...
        self.market_url = f"{self.root_url}apimarketdata/auth/login" 
        self.master_instruments_url = f"{self.root_url}apimarketdata/instruments/master"
        self.interactive_url = f"{self.root_url}interactive/user/session" 
        self.index_list_url = f"{self.root_url}marketdata/instruments/indexlist"
        self.quote_url = f"{self.root_url}marketdata/instruments/quotes"
        self.cover_order_url = f"{self.root_url}interactive/orders/cover"
        self.limit_order_url = f"{self.root_url}interactive/orders"
        self.historical_url =  f"{self.root_url}apimarketdata/instruments/ohlc"
        self.headers = {
    ...
    def update_master_db(self):
        self.get_master({'exchangeSegmentList': ['NSEFO']}) 
        self.get_master({'exchangeSegmentList': ['NSECM']}) 
    ...
    def get_quotes(self, instruments,market_token):
    ...
    def subscribe_symbols(self, instruments,market_token):
        subscription_url = f"{self.root_url}apimarketdata/instruments/subscription"
