...
class XTS:
    def __init__(self):
        self.market_url = "https://developers.symphonyfintech.in/apimarketdata/auth/login" 
        self.master_instruments_url = "https://developers.symphonyfintech.in/apimarketdata/instruments/master"
        self.interactive_url = "https://developers.symphonyfintech.in/interactive/user/session" 
        self.index_list_url = "https://developers.symphonyfintech.in/marketdata/instruments/indexlist"
        self.quote_url = "https://developers.symphonyfintech.in/marketdata/instruments/quotes"
        self.cover_order_url = "https://developers.symphonyfintech.in/interactive/orders/cover"
        self.limit_order_url = "https://developers.symphonyfintech.in/interactive/orders"
        self.options_symbol_url = "https://developers.symphonyfintech.in/apimarketdata/instruments/instrument/optionSymbol"
        self.subscription_url =   "https://developers.symphonyfintech.in/apimarketdata/instruments/subscription"
        self.cancel_all_url = "https://developers.symphonyfintech.in/interactive/orders/cancelall"
        self.historical_url =  "https://developers.symphonyfintech.in/apimarketdata/instruments/ohlc"
        self.daywise_position_url = "https://developers.symphonyfintech.in/interactive/portfolio/positions"
        self.daywise_trade_url = "https://developers.symphonyfintech.in/interactive/orders/trades"
        self.db_config = {
        'host': 'localhost',
        'user': 'root',
        'password': 'pegasus',
