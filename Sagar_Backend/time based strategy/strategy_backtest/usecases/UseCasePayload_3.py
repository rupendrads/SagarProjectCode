        ...
        "legs": [
            {
                ...
                "stop_loss": ["percentage", 25],
                "trailing_sl": {'trail_value_type':'percentage', 'trail_type':'lock', 'priceMove':4, 'sl_adjustment':2},
                "no_of_reentry": 3,
                "simple_momentum": {"value_type":"percentage", "direction":"decay", "value":10},
